...
<body>
	<P><u><b>     Student Attendance Report</b></u></p>
	<form method="post" action="sreport.php?idd=<?php echo $idd; ?>">
...
Name: <?php echo $name;?>   Class: <?php echo $cls;?>   Roll No.: <?php echo $rl;?>   Section: <?php echo $sec;?></div>
	<table>
    <thead>
        <tr><th>Date</th>
            <th>Status</th>
